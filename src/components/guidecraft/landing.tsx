...
export default function Component() {
    return (
      <div className="flex flex-col min-h-dvh bg-gray-900 text-white">
        <header className="relative overflow-hidden">
          ...
          <div className="relative z-10 px-4 py-12 md:px-6 lg:py-20 xl:py-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-gray-300 sm:mt-6 sm:text-xl md:mt-8 md:text-2xl font-roboto">
                Transform your YouTube tutorials into polished, SEO-friendly written guides easily.
              </p>
              <div className="mt-8 sm:mt-10">
                <Link
                  href="/guidecraft/create"
        ...
        <main className="flex-1">
          <section className="py-12 bg-[#1a1a1a] md:py-16 lg:py-20 xl:py-24">
            <div className="container mx-auto px-4 md:px-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold font-montserrat">Save Countless Hours</h3>
                    <p className="text-gray-300 font-roboto">
                      As a gaming content creator, you understand how demanding it is to craft detailed written guides from scratch. Researching, writing, formatting, and optimizing for search engines is a lengthy process. But with GuideCraft, you can skip the hassle and convert your existing YouTube tutorials into comprehensive, professional-grade guides in just a few clicks.
                    </p>
                  </div>
                </div>
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold font-montserrat">Repurpose Your Video Content</h3>
                    <p className="text-gray-300 font-roboto">
                      Introducing GuideCraft, the game-changing tool that allows you to maximize the value of your YouTube videos. Simply enter the URL of your video, and our advanced system will craft a detailed, 2000-word blog post. This post includes step-by-step instructions, tips, and insights directly from your video, ensuring your content is repurposed effectively and professionally.
                    </p>
                  </div>
                </div>
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold font-montserrat">Rank Higher on Google</h3>
                    <p className="text-gray-300 font-roboto">
                      GuideCraft doesn’t just create guides for your audience—it optimizes them for search engines too. By embedding relevant keywords and adhering to SEO best practices, our tool helps your guides achieve higher rankings on Google, driving more traffic to your content and expanding your reach.
                    </p>
                  </div>
                </div>
                <div className="space-y-6">
                  ...
                  <div>
                    <h3 className="text-lg font-bold font-montserrat">Professional-Grade Quality</h3>
                    <p className="text-gray-300 font-roboto">
                      With GuideCraft, your guides are more than just text—they're professionally crafted documents. Our technology ensures each guide is polished, cohesive, and easy to read, maintaining a high standard of quality that reflects your brand’s professionalism.
                    </p>
                  </div>
                </div>
              </div>
